...
{
    [TestFixture]
    public class t01a_Tests_TaflBasic
    {
        /// 0 : 00 : empty,
        /// 1 : 01 : atk : attacker,
        /// 2 : 10 : def : defensor,
    ...
    [TestFixture]
    public class t01b_Tests_TaflCompressed
    {
        /// 0 : 00 : empty,
        /// 1 : 01 : atk : attacker,
        /// 2 : 10 : def : defensor,
        ...
        [TestCase(7, 12)]
        [TestCase(7, 22)]
        public void TaflCompressed_ctor_width_with_even_args_should_throw_ArgumentException(int width, int height)
        {
            Assert.Throws<ArgumentException>(() => new TaflCompressed(width, height));
        }
        [TestCase(6, 7)]
        [TestCase(8, 7)]
        [TestCase(10, 7)]
        [TestCase(12, 7)]
        [TestCase(22, 7)]
        public void TaflCompressed_ctor_height_with_even_args_should_throw_ArgumentException(int width, int height)
        {
            Assert.Throws<ArgumentException>(() => new TaflCompressed(width, height));
        }
        //4<n<16
        ...
        [TestCase(17, 7)]
        [TestCase(21, 7)]
        public void TaflCompressed_ctor_width_with_invalid_args_should_throw_ArgumentOutOfRangeException(int width, int height)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new TaflCompressed(width, height));
        }
        [TestCase(7, 3)]
        [TestCase(7, 17)]
        [TestCase(7, 21)]
        public void TaflCompressed_ctor_height_with_invalid_args_should_throw_ArgumentOutOfRangeException(int width, int height)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new TaflCompressed(width, height));
        }

        [TestCase(13, 13)]
        public void TaflCompressed_ctor_initializes_the_tafl_correctly(int width, int height)
        {
            TaflCompressed sut = new TaflCompressed(width, height);
        ...
        [TestCase(11, 11)]
        public void TaflCompressed_check_non_presence_of_pawn_at_fortress_square(int width, int height)
        {
            TaflCompressed sut = new TaflCompressed(width, height);
        ...
        [TestCase(11, 11)]
        public void TaflCompressed_create_a_board_and_pawns(int width, int height)
        {
            TaflCompressed sut = new TaflCompressed(width, height);
            /*
             x 00 01 02 03 04 05 06 07 08 09 10 x
        ...
        [TestCase(13, 2)]
        [TestCase(-7, 2)]
        public void TaflCompressed_creating_piece_out_of_the_tafl_should_throw_arg_out_of_range_exc(int left, int up)
        {
        ...
        [TestCase(true)]
        [TestCase(false)]
        public void TaflCompressed_HasKing(bool answer)
        {
            TaflCompressed sut = new TaflCompressed(11, 11);
            if (answer) { sut[5, 5] = Pawn.King; }
